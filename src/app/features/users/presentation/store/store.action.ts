...
import { FromType, IResposeGetUsers, IUser, IQueryUser, IQueryUsers, IUserUpdate } from '@users';


export const UserGets       = createAction(`[${userActions}] GETS USERS`,   props<{ params: IQueryUsers; uType: FromType }>());
...
export const UserDelete     = createAction(`[${userActions}] DELETE`,       props<{ id: string; from: FromType }>());
export const UserUpdate     = createAction(`[${userActions}] UPDATE`,       props<{ id: string; item: IUserUpdate }>());
export const UserAdd        = createAction(`[${userActions}] ADD`,          props<{ item: IUser; from: FromType }>());
